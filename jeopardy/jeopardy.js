...
///-when a user clicks a specific screen the id is used
//ie. 23 to determine which category and clue to show
//in this case the third category from the left
//and the fourth clue down
